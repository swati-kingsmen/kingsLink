...
console.log(user,"user check table .........")
      ...
      >
        <Grid templateColumns="repeat(12, 1fr)" gap={2}>
          ...
          >
            {ManageGrid !== false && (
              <Menu isLazy>
                ...
                >
                  ...
                  <MenuItem
                    onClick={() => {
                      const fileUrl = "/files/Contacts.xlsx"; // Relative path to the file in the public folder
                      const link = document.createElement("a");
                      link.href = fileUrl;
                      link.download = "Contacts.xlsx"; // Suggested filename for download
            ...
            {/* {(access?.create || access === true) && user?.designation!=='rm' }
            {
              <Button
                backgroundColor={"#8D6E63"}
                color={"#fff"}
...

{
  ...
  !(user?.designation === 'rm' && title === "Contacts") && (
    <Button
      backgroundColor={"#8D6E63"}
      color={"#fff"}
      onClick={() => handleClick()}
